...
//
// One league per visit, reached from the competition card's Teams
// segment (27C revised). The screen-level all-leagues mode that twice
// briefly lived here was deleted BOTH times with the design that
// needed it (owner ruling 2026-08-18: the card design has no aggregate
// entry, and dead machinery gets resurrected by future sessions that
