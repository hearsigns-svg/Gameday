...
export const pt: Catalog = {
  ...
  'core.status.calendarOff': 'Calendário desativado',
  'core.status.upToDateCalendarOff': 'Jogos em dia · calendário desativado',
  'core.status.notSynced': 'Ainda não está no seu calendário',
  'core.status.updateFailed': 'Não foi possível atualizar seu calendário — vamos tentar de novo',
  'core.error.alreadyUpdating': 'Seu calendário já está sendo atualizado.',
  'core.error.authExpired':
    'O login do Google expirou — reconecte para manter seu calendário em dia.',
  ...
  'follows.boxing.sectionMens': 'Boxe — Masculino',
  'follows.boxing.sectionWomens': 'Boxe — Feminino',
  ...
  'follows.coverage.ufc':
    'Horários por card. O diretório de lutadores é o elenco do UFC por categoria, atualizado a cada trimestre, mais os lutadores dos cards anunciados das outras organizações.',
  ...
  'calendar.layout.separated': 'Seus jogos agora estão em calendários separados',
  'calendar.layout.combined': 'Seus jogos voltaram para um só calendário',
  ...
  'calendar.sessions.qualifying': 'Classificação e corrida',
  'calendar.sessions.all': 'Todas as sessões',
  ...
  'calendar.priming.googleNote':
    'Adicionar jogos ao seu calendário precisa de um login do Google no Android. Sem ele, seus jogos ficam no app.',
  ...
  'settings.calendar.separateSports': 'Um calendário para cada esporte',
  'settings.calendar.separateTitle': 'Mover seus jogos para calendários separados?',
  'settings.calendar.combineTitle': 'Voltar seus jogos para um só calendário?',
  'settings.calendar.moveBody_one':
    'Cores ou visibilidade que você definiu no app de calendário do celular não serão mantidas. Mover {n} jogo pode levar um tempinho.',
  'settings.calendar.moveBody_other':
    'Cores ou visibilidade que você definiu no app de calendário do celular não serão mantidas. Mover {n} jogos pode levar um tempinho.',
  'settings.calendar.moveAction': 'Mover',
  'settings.calendar.onDeviceOnly': 'Só neste aparelho — não aparece nos seus outros aparelhos',
  'settings.calendar.onYourDevices': '{account} — aparece nos seus outros aparelhos',
  'settings.calendar.alongsideYours':
    '{account} — os jogos aparecem ao lado dos seus próprios eventos',
  ...
  'settings.events.footnote':
    'Eventos com horário vão do pontapé inicial ao apito final. As mudanças valem para todos os jogos do seu calendário na próxima atualização.',
  ...
  // ── Data & privacy rows ────────────────────────────────────────────
  'settings.privacy.erase': 'Apagar eventos do seu calendário',
  ...
  'settings.privacy.eraseOursSeparate':
    'Remove os calendários KickOffCal e todos os eventos deles — incluindo os passados. Nada mais no seu calendário é alterado.',
  'settings.privacy.eraseResync':
    'Se o seu calendário continuar conectado, eventos futuros serão adicionados de novo.',
  ...
  'settings.privacy.resetEraseFailed_one':
    '{n} evento não pôde ser removido do seu calendário — nada foi apagado. Tente de novo.',
  'settings.privacy.resetEraseFailed_other':
    '{n} eventos não puderam ser removidos do seu calendário — nada foi apagado. Tente de novo.',
  'settings.privacy.nothingToErase': 'Nada no seu calendário para apagar',
  'settings.privacy.erased': 'Eventos removidos do seu calendário',
  ...
  'settings.privacy.alsoErase': 'Remover também os eventos do KickOffCal do meu calendário',
  ...
  'settings.status.deviceNotSynced': 'Este aparelho: calendário ainda não atualizado',
  'settings.status.deviceSynced': 'Última atualização do calendário neste aparelho: {when}',
  ...
  'registry.tooMany':
    'Seguindo coisas demais para manter tudo em dia ({n} de {limit}). Deixe de seguir algo e isso se resolve.',

  // ── Round 5 Stage 3: paywall, purchase outcomes, subscription state ──
  'paywall.headline': 'Adiciona os jogos ao teu calendário',
  'paywall.lockSync': 'Todos os jogos no teu calendário, sempre atualizados',
  'paywall.lockReminders': 'Três lembretes',
  'paywall.lockColour': 'Cor do calendário',
  'paywall.trialBadge': '14 dias grátis',
  'paywall.monthly': 'Mensal',
  'paywall.annual': 'Anual',
  'paywall.pricePerMonth': '{price} / mês',
  'paywall.pricePerYear': '{price} / ano',
  'paywall.annualSaving': 'Poupa {percent}%',
  'paywall.startTrial': 'Começar teste grátis',
  'paywall.subscribe': 'Subscrever',
  'paywall.restore': 'Restaurar compra',
  'paywall.notNow': 'Continuar com Free',
  'paywall.renewal': 'Renova automaticamente. Cancela quando quiseres.',
  'paywall.trialRenewal': 'Grátis por 14 dias, depois {price} / ano. Renova automaticamente. Cancela quando quiseres.',
  'paywall.terms': 'Termos',
  'paywall.privacy': 'Privacidade',
  'paywall.unavailable': 'Loja indisponível de momento',
  'purchase.pending': 'A aguardar aprovação',
  'purchase.failed': 'A compra não foi concluída',
  'restore.found': 'Subscrição restaurada',
  'restore.none': 'Nenhuma subscrição para restaurar',
  'entitlement.trialDaysLeft': 'Faltam {n} dias',
  'entitlement.trialDaysLeft.one': 'Falta 1 dia',
  ...
  'follows.rail.summerOlympics': 'Jogos Olímpicos de Verão',
  'follows.rail.winterOlympics': 'Jogos Olímpicos de Inverno',
