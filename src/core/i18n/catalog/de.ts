...
export const de: Catalog = {
  ...
  'follows.feedback.notInCalendar': 'Du folgst jetzt {name} — nicht in deinem Kalender',
  'follows.feedback.alreadyInCalendar': 'Du folgst jetzt {name} — schon in deinem Kalender',
  ...
  'calendar.layout.separated': 'Deine Spiele sind jetzt in getrennten Kalendern',
  'calendar.layout.combined': 'Deine Spiele sind wieder in einem Kalender',
  ...
  'calendar.sessions.qualifying': 'Qualifying & Rennen',
  'calendar.sessions.all': 'Alle Sessions',
  ...
  'settings.calendar.separateSports': 'Eigener Kalender für jede Sportart',
  'settings.calendar.separateTitle': 'Deine Spiele in getrennte Kalender verschieben?',
  'settings.calendar.combineTitle': 'Deine Spiele wieder in einen Kalender verschieben?',
  'settings.calendar.moveBody_one':
    'Farben oder Sichtbarkeit, die du in der Kalender-App deines Handys eingestellt hast, werden nicht übernommen. {n} Spiel zu verschieben kann einen Moment dauern.',
  'settings.calendar.moveBody_other':
    'Farben oder Sichtbarkeit, die du in der Kalender-App deines Handys eingestellt hast, werden nicht übernommen. {n} Spiele zu verschieben kann einen Moment dauern.',
  'settings.calendar.moveAction': 'Verschieben',
  ...
  'settings.privacy.eraseOursSeparate':
    'Entfernt die KickOffCal-Kalender und alle Einträge darin — auch vergangene. Sonst wird in deinem Kalender nichts angetastet.',
  ...
  'paywall.trialBadge': '14 Tage gratis',
  'paywall.monthly': 'Monatlich',
  'paywall.annual': 'Jährlich',
  'paywall.pricePerMonth': '{price} / Monat',
  'paywall.pricePerYear': '{price} / Jahr',
  'paywall.annualSaving': '{percent}% sparen',
  'paywall.startTrial': 'Gratis testen',
  'paywall.subscribe': 'Abonnieren',
  'paywall.restore': 'Kauf wiederherstellen',
  'paywall.notNow': 'Mit Free weitermachen',
  'paywall.renewal': 'Verlängert sich automatisch. Jederzeit kündbar.',
  'paywall.trialRenewal': '14 Tage gratis, danach {price} / Jahr. Verlängert sich automatisch. Jederzeit kündbar.',
  'paywall.terms': 'Nutzungsbedingungen',
  'paywall.privacy': 'Datenschutz',
  'paywall.unavailable': 'Store gerade nicht erreichbar',
  'purchase.pending': 'Warten auf Genehmigung',
  'purchase.failed': 'Kauf nicht abgeschlossen',
  'restore.found': 'Abo wiederhergestellt',
  'restore.none': 'Kein Abo zum Wiederherstellen',
  'entitlement.trialDaysLeft': 'Noch {n} Tage',
  'entitlement.trialDaysLeft.one': 'Noch 1 Tag',
