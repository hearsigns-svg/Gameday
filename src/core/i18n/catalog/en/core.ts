...
export const coreStrings = {
  ...
  'core.status.calendarOff': 'Calendar is off',
  'core.status.upToDateCalendarOff': 'Fixtures up to date · calendar off',
  'core.status.notSynced': 'Not in your calendar yet',
  'core.status.updateFailed': 'Couldn’t update your calendar — will retry',
  'core.error.alreadyUpdating': 'Your calendar is already updating.',
  'core.error.authExpired': 'Google sign-in expired — reconnect to keep your calendar up to date.',
