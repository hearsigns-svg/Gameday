...
export const calendarStrings = {
  ...
  'calendar.control.addA11y': 'Add {name} to calendar',
  'calendar.control.inA11y': '{name} is in your calendar',
  'calendar.control.added': '{name} added to your calendar',
  'calendar.control.removed': '{name} removed from your calendar',
  'calendar.control.sportAdded': 'All {sport} added to your calendar',
  'calendar.control.sportRemoved': 'All {sport} removed from your calendar',
