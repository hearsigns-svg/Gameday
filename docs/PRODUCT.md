...
Premium SETTINGS (calendar colour, a calendar per sport, an event's own
colour on Google Calendar) are shown to everyone: in the free state a tap opens the offer and changes nothing;
